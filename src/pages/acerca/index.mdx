...
export const imageQuery = graphql`
  query {
    ciudad_panama: file(relativePath: { eq: "ciudad-panama-pacifico.jpg"}) {
      childImageSharp {
        fluid(maxWidth: 300) {
...
# Diseñador y Desarrollador de Aplicaciones Web

Mi nombre es _Juan Moisés Torrijos_ y soy **diseñador y programador** de **sitios y aplicaciones** para la web.

<Img 
  fluid={props.data.ciudad_panama.childImageSharp.fluid}
  className="image-float-left small-shadow small-border"
