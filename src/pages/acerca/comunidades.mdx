...
<Img 
  ...
  className="image-float right small-border transparent-shadow"
  alt='Wappu Montuno'
/>
...
<Img 
  ...
  className="image-float right small-shadow small-border"
  alt='PanamaJS Logo'
/>
...
<Img 
  ...
  className="image-float right transparent-shadow small-border"
